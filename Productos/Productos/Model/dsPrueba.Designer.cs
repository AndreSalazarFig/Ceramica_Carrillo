            ...
            public string Nombre_del_empleado {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Nombre del empleado\' in table \'Folio\' is DBNull.", e);
                    }
                }
                set {
...
namespace CeramicaCarrillo.Model.dsPruebaTableAdapters {
    ...
    public partial class FolioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        f.IdFolio, f.TotalVenta, f.FechaVenta, p.Nombre + ' ' + p.Apellido AS [Nombre del empleado]
FROM            Folio AS f INNER JOIN
                         Personal AS p ON f.IdPersonal = p.IdPersonal
WHERE        f.Status = 1
ORDER BY f.IdFolio asc";
